...
function Card(){
    return(
        <>
            <section className="flex flex-col md:w-80 p-2 text-center text-sm gap-2 border rounded bg-gray-300 transition-transform duration-300 hover:scale-105 hover:shadow-lg" data-aos="fade-up" data-aos-delay="200">
