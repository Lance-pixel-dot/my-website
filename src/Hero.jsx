        ...
        <>
            <section className="flex flex-col md:flex-row p-3 lg:w-11/12 mb-3 h-screen place-self-center md:text-start text-center md:justify-center" id="hero">
                ...
                <section className="flex flex-col self-stretch justify-center md:ml-4">
                    <p className="mb-4" data-aos="fade-up" data-aos-delay="200">Welcome! I'm Renier Lawrence Tuico, a web developer. I enjoy building creative projects, learning new tools and technologies, and sharing what I learn along the way. Take a look at some of my work below!</p>
